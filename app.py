...
# ==================== روابط التطبيقات ====================
# ضع روابط تطبيقاتك الحقيقية هنا
APP_LINKS = {
    "soko_link": "https://soko-link-kfayyoqvr3shxvszm3y9rw.streamlit.app/",  # غيّر إلى رابط SOKO LINK الحقيقي
    "datacollect": "https://datacollect-ug-grpssnnub8pdr4anlafo2q.streamlit.app/",  # غيّر إلى رابط DataCollect UG الحقيقي
    "govfeedback": "https://mkdir-govfeedback-az6rjzjegwgktvf2mq6ypr.streamlit.app/",  # غيّر إلى رابط GovFeedback AI Agent الحقيقي
    "portfolio": "https://portfolio-yourname.streamlit.app"  # غيّر إلى رابط البورتفوليو
}
...
# ==================== صفحة الحكومة ====================
    ...
    with col2:
        ...
        # رابط GovFeedback AI Agent الحقيقي
